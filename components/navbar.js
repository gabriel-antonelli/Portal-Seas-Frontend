                ...
                <>
                    <div className="px-2 mx-auto max-w sm:px-6 lg:px-8">
                        <div className="flex relative justify-between items-center h-16">
                                            ...
                                            <Link href={item.href} key={item.href}>
                                                <a
                                                    ...
                                                    className={classNames(
                                                        document.documentURI.endsWith(item.href) ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                            ...
                            <div
                                className="flex absolute inset-y-0 right-0 items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
