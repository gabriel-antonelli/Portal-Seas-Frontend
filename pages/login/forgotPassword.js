...
export default function ForgotPassword() {
    ...
    return (
        <>
            <Alert show={alert} func={handleShow} label="Uma nova senha foi enviada ao seu email." color="blue"/>
            <div className="flex justify-center items-center h-screen bg-gray-50">
                <div className="flex justify-center items-center">
                    <div className="flex w-screen">
                        <div
                            className="hidden mx-12 w-full h-auto bg-no-repeat rounded-lg 2xl:bg-seas-lg bg-seas-sm lg:block"/>
                        <div className="p-12 w-full bg-gray-50">
                            ...
                            <form onSubmit={handleSubmit} className="pt-6 pb-8 mb-4 rounded bg-grey-50">
                                <div className="mb-4">
